...
class SoftmaxOp(IRDLOperation):
    ...
    name = "model2mlir.linalg_ext.softmax"
...
class LayerNormOp(IRDLOperation):
    ...
    name = "model2mlir.linalg_ext.layer_norm"
...
class RMSNormOp(IRDLOperation):
    ...
    name = "model2mlir.linalg_ext.rms_norm"
...
class RoPEOp(IRDLOperation):
    ...
    name = "model2mlir.linalg_ext.rope"
...
class SwiGLUOp(IRDLOperation):
    ...
    name = "model2mlir.linalg_ext.swiglu"
...
class GeluOp(IRDLOperation):
    ...
    name = "model2mlir.linalg_ext.gelu"
...
class SiluOp(IRDLOperation):
    ...
    name = "model2mlir.linalg_ext.silu"
