...
The self-updating coverage loop lives under `model2mlir.capture.unsupported`;
...
from model2mlir.capture.torch_mlir_bridge import bridge_fx_graph, module_to_text
...
def convert(
    ...
    *,
    ...
    if decompose:
        try:
            from model2mlir.capture.torch_export import capture_frontend_artifact
