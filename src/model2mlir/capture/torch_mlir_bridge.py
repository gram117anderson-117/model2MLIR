...
Usage:
    ...
    from model2mlir.capture.torch_mlir_bridge import bridge_fx_graph
...
def _parse_mlir_text_to_xdsl(mlir_text: str) -> ModuleOp | None:
    ...
    try:
        from model2mlir.ir.linalg_ext import LinalgExt
        from model2mlir.ir.quant import Quant
        from model2mlir.ir.tensor_ext import TensorExt
...
def bridge_fx_graph(
    ...
    *,
    ...
    try:
        from model2mlir.capture.torch_export import capture_model
        from model2mlir.ir.import_fx import FXImporter
