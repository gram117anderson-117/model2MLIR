...
Register with::
    ...
    ctx.register_dialect("model2mlir.linalg_ext", lambda: LinalgExt)
"""

from __future__ import annotations

from model2mlir.ir.linalg_ext.dialect import ALL_ATTRS, ALL_OPS, LinalgExt
from model2mlir.ir.linalg_ext.ops import (
    GeluOp,
    LayerNormOp,
    RMSNormOp,
    RoPEOp,
