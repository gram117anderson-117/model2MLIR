...
Register on a ``Context`` with::
    ...
    ctx.register_dialect("model2mlir.tensor_ext", lambda: TensorExt)
"""

from __future__ import annotations

from model2mlir.ir.tensor_ext.dialect import ALL_ATTRS, ALL_OPS, TensorExt
from model2mlir.ir.tensor_ext.ops import ConcatOp, PackOp, UnpackOp
