...
- The *result type* is an ordinary ``TensorType``. Quantization-specific
  ...
  ``qtype`` property (defined in :mod:`model2mlir.ir.quant.types`).
...
from model2mlir.ir.quant.types import AffineQuantizedTensorType
...
class QuantizePerTensorOp(IRDLOperation):
    ...
    name = "model2mlir.quant.quantize_per_tensor"
...
class DequantizePerTensorOp(IRDLOperation):
    ...
    name = "model2mlir.quant.dequantize_per_tensor"
...
class QuantizePerChannelOp(IRDLOperation):
    ...
    name = "model2mlir.quant.quantize_per_channel"
...
class DequantizePerChannelOp(IRDLOperation):
    ...
    name = "model2mlir.quant.dequantize_per_channel"
...
class QuantizePerGroupOp(IRDLOperation):
    ...
    name = "model2mlir.quant.quantize_per_group"
...
class DequantizePerGroupOp(IRDLOperation):
    ...
    name = "model2mlir.quant.dequantize_per_group"
...
class WeightInt8PackMMOp(IRDLOperation):
    ...
    name = "model2mlir.quant.weight_int8pack_mm"
...
class WeightInt4PackMMOp(IRDLOperation):
    ...
    name = "model2mlir.quant.weight_int4pack_mm"
...
class WeightInt4PackQMOp(IRDLOperation):
    ...
    name = "model2mlir.quant.weight_int4pack_qm"
...
class ChooseQParamsPerTensorOp(IRDLOperation):
    ...
    name = "model2mlir.quant.choose_qparams_per_tensor"
...
class ChooseQParamsPerChannelOp(IRDLOperation):
    ...
    name = "model2mlir.quant.choose_qparams_per_channel"
...
class FakeQuantOp(IRDLOperation):
    ...
    name = "model2mlir.quant.fake_quantize"
